## This script executes a series of data visualizations pertaining to multivariate statistical analyses on all ClinVar allele categories drawn from our list of 199 anemia-enriched loci.
